...
def Clavier(event):
    ...
    global FeuRouge,FeuBleu,EtatMissileRouge,EtatMissileBleu
    touche = event.keysym
    # la touche espace pour les missiles
    if touche =='c':
        FeuRouge=True
...
AbsMissileBleu=AbsMissileBleuDepart
AbsMissilerouge=AbsMissilerougeDepart
...
photoMissile=PhotoImage(file="C:\\Users\\Jeremy\\Documents\\isnjere\\projet\\Projet\\ImagesISN\\missile.gif")
...
if BonusMissileBleu==True and FeuBleu==True and EtatMissileBleu>=0:
    BonusMissilebleu1=Canevas.create_image(AbsMissileBleuDepart,MilieuHauteurPaletteBleue+50,image=photoMissile)
    BonusMissilebleu2=Canevas.create_image(AbsMissileBleuDepart,MilieuHauteurPaletteBleue-50,image=photoMissile)
    
if BonusMissileRouge==True and EtatMissileRouge>=0 and FeuRouge==True :
    BonusMissilerouge1=Canevas.create_image(AbsMissilerougeDepart,MilieuHauteurPaletteRouge+50,image=photoMissile)
    BonusMissilerouge2=Canevas.create_image(AbsMissilerougeDepart,MilieuHauteurPaletteRouge-50,image=photoMissile)
...
def AffichageGeneral():
    ...
    global AbsMissileBleu,AbsMissilerouge
    ...
    if BonusMissileBleu==True and FeuBleu==True and EtatMissileBleu>=0:
        AbsMissileBleu-=3
        BonusMissilebleu1=Canevas.create_image(AbsMissileBleu,MilieuHauteurPaletteBleue+50,image=photoMissile)
        BonusMissilebleu2=Canevas.create_image(AbsMissileBleu,MilieuHauteurPaletteBleue-50,image=photoMissile)
        
    if BonusMissileRouge==True and EtatMissileRouge>=0 and FeuRouge==True :
        AbsMissilerouge+=3
        BonusMissilerouge1=Canevas.create_image(AbsMissilerouge,MilieuHauteurPaletteRouge+50,image=photoMissile)
        BonusMissilerouge2=Canevas.create_image(AbsMissilerouge,MilieuHauteurPaletteRouge-50,image=photoMissile)
