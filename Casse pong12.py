...
def MissileBrique(AbsBalle,OrdBalle,SensDeplacement,largeurBrique,DiametreBalles,DeplacementVertical):
    ...
    global BonusMissilerouge1,BonusMissilerouge2
...
AbsMissileBleu1=AbsMissileBleuDepart
AbsMissileBleu2=AbsMissileBleuDepart
AbsMissilerouge1=AbsMissilerougeDepart
AbsMissilerouge2=AbsMissilerougeDepart
OrdMissileBleuHaut=MilieuHauteurPaletteBleue-70
OrdMissileRougeHaut=MilieuHauteurPaletteRouge-70
OrdMissileBleuBas=MilieuHauteurPaletteBleue+70
OrdMissileRougeBas=MilieuHauteurPaletteRouge+70
...
photoMissileRouge=PhotoImage(file="C:\\Users\\Jeremy\\Documents\\isnjere\\projet\\Projet\\ImagesISN\\missileRouge.gif")
photoMissileBleu=PhotoImage(file="C:\\Users\\Jeremy\\Documents\\isnjere\\projet\\Projet\\ImagesISN\\missileBleue.gif")
...
#vitesses et sens de deplacements des balles 
    ...
    MissileBrique(AbsBalleBleue,OrdBalleBleue,vitesseX2,largeurBrique,DiametreBalles,vitesseY2)
    MissileBrique(AbsBalleRouge,OrdBalleRouge,vitesseX,largeurBrique,DiametreBalles,vitesseY)
