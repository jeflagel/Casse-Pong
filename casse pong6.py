...
#vitesses et sens de deplacements des balles 
    ...
    vitesseX2=RebondBrique(AbsBalleBleue,OrdBalleBleue,vitesseX2,largeurBrique,DiametreBalles)
    vitesseX=RebondBrique(AbsBalleRouge,OrdBalleRouge,vitesseX,largeurBrique,DiametreBalles)
