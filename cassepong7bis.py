...
def RebondPalettes(AbsBalle,OrdBalle,SensDeplacement):
    ...
    if AbsBalle+DiametreBalles>=BordDroit:# and OrdBalle<=MilieuHauteurPaletteBleue+50 and OrdBalle>=MilieuHauteurPaletteBleue-50:
        SensDeplacement=-SensDeplacement-vitesseAjoute
        
    elif AbsBalle<=BordGauche: #and OrdBalle<=MilieuHauteurPaletteRouge+50 and OrdBalle>=MilieuHauteurPaletteRouge-50:
          SensDeplacement=-SensDeplacement+vitesseAjoute
...
def RebondBrique(AbsBalle,OrdBalle,SensDeplacement,largeurBrique,DiametreBalles,DeplacementVertical):
    global indiceCoté,compteurScore,score
...
def affichageScore ():
    ...
    Label(texte1,text=score).pack(padx=10,pady=10)
    
def imgaffiche(): 
    img = Tk.PhotoImage(file = C:/Users/You go/Desktop/1002.gif)  ## Création d'un objet PhotoImage qui reconnait les extensions .gif et .ppm     
    gifsdict[C:/Users/You go/Desktop/1002.gif] = img              ## si on commente cette ligne, l'image ne s'affichera pas 
    button.configure(image=img)          ## Ajout de l'image sur le bouton 
    ## On pourrait aussi directement faire 
    ## gifsdict[C:/Users/You go/Desktop/1002.gif] = Tk.PhotoImage(file = C:/Users/You go/Desktop/1002.gif)               
    ## button.configure(image = gifsdict[C:/Users/You go/Desktop/1002.gif]) 
  
root = Tk.Tk() 
button = Tk.Button(text = "affiche image", command = imgaffiche) 
  
C:/Users/You go/Desktop/1002.gif = strchemin ## strchemin:str, chemin d'accès à l'image 
