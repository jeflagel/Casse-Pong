...
def MissileBrique(SensDeplacement,largeurBrique,DiametreBalles,DeplacementVertical,AbsMissile):
    ...
    if AbsMissile>=AbscisseMur and AbsMissile<=AbscisseMur+(NbColonneMur*(largeurBrique+2))-2: # partie ou la balle est susceptible de rebondir
        colonne=int((AbsMissile-AbscisseMur)/largeurBrique)    # combien de colonnes entre balle et abscisse mur
