...
def RebondPalettes(AbsBalle,OrdBalle,SensDeplacementX,SensDeplacementY):
    ...
    if BonusBouclierBleu==True:
        ...
        elif AbsBalle+DiametreBalles>=BordDroit and (OrdBalle>MilieuHauteurPaletteBleue+50 or OrdBalle<MilieuHauteurPaletteBleue-50) and EtatBouclierBleu!=0 :
            SensDeplacementX=-SensDeplacementX-vitesseAjoute
            EtatBouclierBleu-=1
    ...
    if BonusBouclierRouge==True:
        ...
        elif AbsBalle<=BordGauche and (OrdBalle>MilieuHauteurPaletteRouge+50 or OrdBalle<MilieuHauteurPaletteRouge-50) and EtatBouclierRouge!=0 :
            SensDeplacementX=-SensDeplacementX
            EtatBouclierRouge-=1
...
photoPaletteBleu=PhotoImage(file="C:\\Users\\Jeremy\\Documents\\isnjere\\projet\\Projet\\ImagesISN\\paletteBleu.gif")
photoPaletteRouge=PhotoImage(file="C:\\Users\\Jeremy\\Documents\\isnjere\\projet\\Projet\\ImagesISN\\paletteRouge.gif")
...
def AffichageGeneral():
    ...
    global DiametreBalles,AbsBonus,OrdBonus,DescenteBonus
...
#vitesses et sens de deplacements des balles 
    ...
    if AbsBalleRouge+1.5*DiametreBalles<=BordGauche:
        ...
        Frame1 = Frame(Mafenetre,borderwidth=1,relief=GROOVE)
        Frame1.pack(side=LEFT,padx=10,pady=10)
        Label(Frame1,text="Le joueur bleu gagne2").pack(padx=10,pady=10)
